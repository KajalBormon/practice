...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #5a0533; border-bottom:1px solid black;box-shadow: 3px 3px 5px;">
        <div class="row" style="font-family:'PT Serif';font-size:22px;">
            ...
            <div class="container col-md-8">
                <div class="row">
                    <div class="col-md-3"></div>
                        <div class="col-md-6" style="background: #5a0533;">
                            <h3 class="text-center text-light">Class Management System</h3>
                        </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            
            <div class="container col-md-10 collapse navbar-collapse mnav" id="navbarResponsive">
