...
<body style="background-color: white;">
    ...
    <center>
        ...
        <div class="container-fluid">
            <div class="row">
                <!-- <div class="bg-light border-bottom p-2 col-md-6">
                    <a href="./spread_sheet/generate_spread_sheet.php" class="btn btn-success">Download Exel</a>
                </div> -->
                <div class="content center" id="content2">
                    ...
                    <form method="post" action="" class="form-horizontal col-md-6 col-md-offset-3 selectform">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" id="show" class="col-md-5" value="Show!" name="sr_btn" />
                        ...
                        <table class="table table-striped">
                            ...
                            if (isset($_POST['sr_btn'])) {
                                ...
                                if ($count_total > 0) {
                                    ...
                                    $err = "<font color='red'>No Data Found. Please contact with the admin.....!</font>";
                                }
                            } ?>
